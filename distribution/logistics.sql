...
create table Admin(
	...
	UserID nvarchar(10),				
	AdminType int,						
	AdminChina nvarchar(10),		
	AdminSite nvarchar(10),			
	AdminPwd nvarchar(10),			
	AdminTEL nvarchar(20),			
	AdminNotes nvarchar(50),		
	Primary key(AdminID),
	foreign key(UserID) references User(UserID)
);
...
create table Order_List(
	...
	OrderKG int,						
	OrderMail nvarchar(20),			
	OrderMailSite nvarchar(50),	
	OrderProfile nvarchar(50),		
	OrderStatus int,					
	OrderPostPhone nvarchar(20),	
	OrderCNEE nvarchar(20),			
	OrderPhone nvarchar(20),		
	OrderStart nvarchar(10),		
	OrderMiddle nvarchar(10),		
	OrderTerminus nvarchar(10),	
	OrderShip decimal(18,0),		
	OrderDC decimal(18,0),			
	OrderMove decimal(18,0),		
	OrderSum nvarchar(10),			
	OrderCar nvarchar(10),			
	OrderNotes nvarchar(50),		
	Primary key(OrderID)
);

insert into Order_List values
('1',1,'147','a',10,'张三','北京市东城区','广东省湛江市遂溪县',1,'333','zs','123','江西','赣州','于都',10,5,10,'25','奥迪',null),
